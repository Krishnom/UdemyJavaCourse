...
public class WallTest{
    ...
    @Test public void areaIs0WhenWidthAndHeightIsZero(){
        Wall wall = new Wall(0,0);
        assertEquals(0.0,wall.getArea(),0.0);
    }

    @Test public void areaIs0WhenWidthIsNegative(){
        Wall wall = new Wall(-1,10);
        assertEquals(0.0,wall.getArea(),0.0);
    }

    @Test public void areaIs0WhenHeightIsNegative(){
        Wall wall = new Wall(10,-1);
        assertEquals(0.0,wall.getArea(),0.0);
    }

    @Test public void areaIs_121_When_WidthIs_11_and_HeightIs_11(){
